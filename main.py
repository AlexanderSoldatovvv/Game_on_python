...
WINDOW_TITLE = "MyFirstGameOnPython"
...
class MenuButton:
    ...
    def draw(self, screen):
        ...
        if self.active_image:
            screen.blit(self.active_image, (self.rect.x, self.rect.y))
...
class Menu:
    def __init__(self):
        ...
        self.buttons = [
            MenuButton(540, 300, 200, 50, (233, 164, 83), (0, 0, 0), 'PLAY'),
            MenuButton(540, 400, 200, 50, (233, 164, 83), (0, 0, 0), 'EXIT')
        ]
